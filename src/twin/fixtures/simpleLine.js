// simpleLine fixture — §6 worked example (engine unit-test reference line).
//
// This is the minimal 3-station linear line the engine unit tests are written
// against (exact §6 timeline). The app's headline `linearLine.js` fixture was
// re-purposed to model the full M800 value stream, so the deterministic
// worked-example assertions live here on a dedicated, stable topology.
// Exported as `makeLinearLineFixture` to match the original test imports.
//
